    ...
    <nav className="bg-blue-900 py-2">
      <div className="max-w-[1370px] mx-auto">
        <div className="flex justify-between">
          <div>
            <h1 className="font-primary text-3xl font-normal tracking-widest text-white">
              Converter
            </h1>
          </div>

          <div className="flex items-center flex-row-reverse gap-x-2">
          <h2 className="font-medium text-base text-white">{`${open? "Enable" : "Disabled"} `}Dark Mode</h2>
